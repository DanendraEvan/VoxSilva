  ...
  return (
    <footer className="relative bg-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1448375240586-882707db888b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')] bg-cover bg-center opacity-30"></div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@voxsilva.id" className="text-gray-300 hover:text-green-400 transition-colors">info@voxsilva.id</a>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} VoxSilva All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Kebijakan Cookie</a>
            </div>
          </div>
        </motion.div>
      </div>
